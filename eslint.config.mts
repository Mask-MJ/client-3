...
export default defineConfigWithVueTs(
  ...
  // javascript
  {
    ...
    name: 'app/files-to-lint-javascript',
  ...
  // typescript
  {
    ...
    name: 'app/files-to-lint-typescript',
    plugins: {
  ...
  {
    files: ['**/*.d.ts'],
    name: 'app/files-to-disables-dts',
    rules: {
  ...
  {
    name: 'app/files-to-lint-perfectionist',
    rules: {
      ...
      'perfectionist/sort-imports': [
        ...
        {
          customGroups: {
            type: { 'vue-type': ['^vue$', '^vue-.+', '^@vue/.+'] },
            value: { vue: ['^vue$', '^vue-.+', '^@vue/.+'] },
          },
          environment: 'node',
          groups: [
  ...
  // unicorn
  {
    name: 'app/files-to-lint-unicorn',
